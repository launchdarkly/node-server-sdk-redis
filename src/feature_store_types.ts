...
// or "any" for these things in its LDFeatureStore interface. Changing that interface in the SDK
// would technically be a breaking change even if the underlying behavior was the same, so until
// the next major version of the SDK, these types are declared within each database package.
